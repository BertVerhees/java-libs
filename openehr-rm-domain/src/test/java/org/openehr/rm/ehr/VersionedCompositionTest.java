...
public class VersionedCompositionTest extends CompositionTestBase {
	...
	public void testCommit() throws Exception {
		...
		vc.commitOriginalVersion(new ObjectVersionID(
				"1.2.4.7::1.2.40.14.1.2.2::2"), new ObjectVersionID(
				"1.2.4.7::1.2.40.14.1.2.2::1"), composition("at0001",
				"subsequent"), audit(TestCodeSetAccess.AMENDMENT),
				contribution("1.5.25.6.2.1.2"), TestCodeSetAccess.AMENDMENT,
				null, ts);
	}

	private void assertExceptionThrown(VersionedComposition vc, Composition data)
			throws Exception {
		try {
			vc.commitOriginalVersion(new ObjectVersionID(
					"1.7.5.2::1.2.40.14.1.2.2::2"), new ObjectVersionID(
					"1.7.5.2::1.2.40.14.1.2.2::1"), data,
					audit(TestCodeSetAccess.AMENDMENT),
					contribution("1.5.25.6.2.1.2"),
	...
	private Composition compositionPersistent(String node, String text)
		...
		Archetyped archetypeDetails = new Archetyped(new ArchetypeID(
				"openehr-ehr_rm-Composition.physical_examination.v2"), "1.0");
		return new Composition(id, node, name, archetypeDetails, null, null,
				null, content, TestTerminologyAccess.ENGLISH, null, provider(),
