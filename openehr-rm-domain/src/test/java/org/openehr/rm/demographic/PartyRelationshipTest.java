...
public class PartyRelationshipTest extends DemographicTestBase {
	...
	public void testConstructor() throws Exception {
		...
		// null details
		new PartyRelationship(oid, meaning, name, null, null, null, null, null,
				null, source, target);
	...
	private void assertException(UIDBasedID oid, String meaning, DvText name,
			ItemStructure details, DvInterval<DvDate> timeValidity,
			ObjectRef source, ObjectRef target) throws Exception {
