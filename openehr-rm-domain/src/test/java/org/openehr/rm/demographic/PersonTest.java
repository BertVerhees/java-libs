...
public class PersonTest extends DemographicTestBase {
	...
	public void testConstructor() throws Exception {
		...
		// null contacts
		new Person(uid, "at0000", name, archetypeDetails, null, null,
				identities, null, relationships, reverseRelationships, details,
				null, languages);
		...
		assertExceptionThrow(uid, meaning, name, null, identities, contacts,
	...
	private void assertExceptionThrow(UIDBasedID uid, String meaning,
			...
			Set<LocatableRef> revRelationships, ItemStructure details,
			Set<Role> roles, Set<DvText> languages) {
		try {
