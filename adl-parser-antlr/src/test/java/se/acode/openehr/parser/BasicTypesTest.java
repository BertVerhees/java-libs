...
public class BasicTypesTest extends ParserTestBase {
	...
	public void testBooleanConstraints() throws Exception {
		...
		assertCBoolean(list.get(3), true, false, false, false);

		// with assumed values
		assertCBoolean(list.get(4), true, false, false, true);

		assertCBoolean(list.get(5), false, true, true, true);

		assertCBoolean(list.get(6), true, true, true, true);
		assertCBoolean(list.get(7), true, false, true, true);
	}
	...
	public void testDateConstraints() throws Exception {
		...
		assertCDate(list.get(7), null, lessThan(date("2004-09-21")), null,
				null);

		assertCDate(list.get(8), null, lessEqual(date("2004-09-22")), null,
				null);

		assertCDate(list.get(9), null, greaterThan(date("2004-09-23")), null,
				null);

		assertCDate(list.get(10), null, greaterEqual(date("2004-09-24")), null,
				null);

		// test assumed values
		assertCDate(list.get(11), "yyyy-mm-dd", null, null, "2000-01-01");

		assertCDate(list.get(12), "yyyy-??-??", null, null, "2001-01-02");

		assertCDate(list.get(13), "yyyy-mm-??", null, null, "2002-01-03");

		assertCDate(list.get(14), "yyyy-??-XX", null, null, "2003-01-04");
		...
		assertCDate(list.get(17), null, new Interval<DvDate>(
				date("2004-09-25"), date("2004-10-25")), null,
				"2004-09-30");

		assertCDate(list.get(18), null, lessThan(date("2004-09-26")), null,
				"2004-09-01");

		assertCDate(list.get(19), null, lessEqual(date("2004-09-27")), null,
				"2003-09-20");

		assertCDate(list.get(20), null, greaterThan(date("2004-09-28")), null,
				"2005-01-02");

		assertCDate(list.get(21), null, greaterEqual(date("2004-09-29")), null,
				"2005-10-30");
	}
	...
	public void testDateTimeConstraints() throws Exception {
		...
		assertCDateTime(list.get(16), null,
				lessThan(dateTime("2000-01-02T00:00:00")), null, null);
